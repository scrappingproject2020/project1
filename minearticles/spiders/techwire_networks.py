...
class TechwireNetworksSpider(scrapy.Spider):
    name = 'techwire_networks'
    allowed_domains = ['www.techwireasia.com/tag/networks']
    start_urls = ['https://www.techwireasia.com/tag/networks/']
