...
class TechwireEcommerceSpider(scrapy.Spider):
    name = 'techwire_ecommerce'
    allowed_domains = ['www.techwireasia.com/tag/e-commerce']
    start_urls = ['https://www.techwireasia.com/tag/e-commerce/']
