...
class OpengovCriticaleventmanagementSpider(scrapy.Spider):
    name = 'opengov_criticaleventmanagement'
    allowed_domains = ['www.opengovasia.com']
    start_urls = ['https://www.opengovasia.com/critical-event-management']
